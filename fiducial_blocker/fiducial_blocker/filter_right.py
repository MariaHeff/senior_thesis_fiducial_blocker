...
import numpy as np
import cv2
class FiducialFilterNodeRight(Node):
	def __init__(self):
		super().__init__('fiducial_filter_node_right')
		# Camera topic to filter
		self.camera_topic = "/spot1/camera/right/compressed"
		self.filtered_camera_topic = "/spot1/camera/right/filtered"
	...
	def camera_callback(self, msg):
		...
		camera_name = "right" # Adjust according to world objects format
