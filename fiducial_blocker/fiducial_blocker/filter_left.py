...
import numpy as np
import cv2
class FiducialFilterNodeLeft(Node):
	def __init__(self):
		super().__init__('fiducial_filter_node_left')
		# Camera topic to filter
		self.camera_topic = "/spot1/camera/left/compressed"
		self.filtered_camera_topic = "/spot1/camera/left/filtered"
	...
	def camera_callback(self, msg):
		...
		camera_name = "left" # Adjust according to world objects format
